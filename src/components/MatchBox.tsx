...
export function MatchBox({ match, onClick, teamRankings, playerCountries = {} }: MatchBoxProps) {
          ...
          <div className="flex-1 min-w-0">
            <div className="text-sm text-gray-900 truncate">
              <span className="inline-flex items-center gap-1 min-w-0">
                <CountryFlag country={playerCountries[match.team1.player1.name]} className="shrink-0" />
                <span className="truncate">{match.team1.player1.name}</span>
              </span>
            ...
            <div className="text-sm text-gray-900 truncate">
              <span className="inline-flex items-center gap-1 min-w-0">
                <CountryFlag country={playerCountries[match.team1.player2.name]} className="shrink-0" />
                <span className="truncate">{match.team1.player2.name}</span>
              </span>
      ...
      <div className={`px-3 py-2 ${team2Won ? 'bg-blue-50 font-semibold' : ''}`}>
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            <div className="text-sm text-gray-900 truncate">
              <span className="inline-flex items-center gap-1 min-w-0">
                <CountryFlag country={playerCountries[match.team2.player1.name]} className="shrink-0" />
                <span className="truncate">{match.team2.player1.name}</span>
              </span>
            ...
            <div className="text-sm text-gray-900 truncate">
              <span className="inline-flex items-center gap-1 min-w-0">
                <CountryFlag country={playerCountries[match.team2.player2.name]} className="shrink-0" />
                <span className="truncate">{match.team2.player2.name}</span>
              </span>
